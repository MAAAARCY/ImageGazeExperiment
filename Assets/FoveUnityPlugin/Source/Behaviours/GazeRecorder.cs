...
public class GazeRecorder : MonoBehaviour
{
    ...
    private void RecordDatum(bool immediate)
    {
        ...
        dataSlice.Add(datum);
        // Debug.Log("x:" + hmdPosition.x + " y:" + hmdPosition.y + " z:" + hmdPosition.z);
        var eyesStateLeft = datum.EyesState.left.value.ToString();
        var eyesStateRight = datum.EyesState.right.value.ToString();

        Debug.Log("left:" + eyesStateLeft + " " + "right:" + eyesStateRight + " " + closedEye);
        if (eyesStateLeft == "Closed" && eyesStateRight == "Closed") {
